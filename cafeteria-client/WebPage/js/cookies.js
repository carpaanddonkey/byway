...
function checkCookie(win){          //窗口号
    ...
    for(var i=1;i<cart_count;i++){
        ...
        if(c!==""){
            ...
            tdN.innerHTML = i;
            tdC.innerHTML = 
                    "<span class='am' onclick='RedItem(\""+win+"\",\""+i+"\")'>-&nbsp</span>" + "<span id='count"+i+"'>" +c +"</span>"+ "<span class='am' onclick='AddItem(\""+win+"\",\""+i+"\")'>&nbsp+</span>";
            tdP.innerHTML = 15;
...
function addToCart(num , win){       //num是商品号，按顺序从1开始  win是窗口号
    ...
    if (value==null || value=="" || value=="undefined" || value =='NaN'){
        setCookie("cart"+win+"com"+num,1,365);      //存的是该商品的个数
            ...
            tdN.innerHTML = num;
            tdC.innerHTML = 
                    "<span class='am' onclick='RedItem(\""+win+"\",\""+num+"\")'>-&nbsp</span>" + "<span id='count"+num+"'>" +1 +"</span>"+ "<span class='am' onclick='AddItem(\""+win+"\",\""+num+"\")'>&nbsp+</span>";
            tdP.innerHTML = 15;  //金额
            tdO.innerHTML = "<span onclick='DelItem(\""+win+"\",\""+num+"\")'>×</span>";
        ...
        window.parent.document.getElementById("count"+num).innerHTML = value;
    }
